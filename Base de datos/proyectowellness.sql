...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-08-2026 a las 01:32:28
...
(532, 23, 'Gone Girl', 'Perfection Learning Corporation', 'Descripción no disponible', 'http://books.google.com/books/content?id=gX0vzgEACAAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api', 0, '', '2019', 'gX0vzgEACAAJ', '2026-08-02 12:09:29', ''),
(534, 23, 'Tinker Tailor Soldier Spy', 'John le Carré', 'Discover the new Penguin Crime and Espionage series A Russian mole has infiltrated the British establishment - and the spymaster Smiley must dig them out... George Smiley, formerly of the Secret Intelligence Service, is contemplating his new life in retirement when he is called back on an unexpected mission. His task is to hunt down an agent implanted by Moscow Central at the very heart of the Circus - one who has been buried deep there for years. The dogged, troubled Smiley can discount nobody from being the traitor, even if it is one of those closest to him.', 'http://books.google.com/books/content?id=4G9ODwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api', 396, 'Fiction', '2018-09-27', '4G9ODwAAQBAJ', '2026-08-02 12:09:29', ''),
(535, 23, 'Madame Bovary', 'Gustave Flaubert', 'Descripción no disponible', 'http://books.google.com/books/content?id=inyZhYeLdV0C&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api', 264, '', '1999', 'inyZhYeLdV0C', '2026-08-02 12:09:29', ''),
(536, 23, 'Neuromante', 'William Gibson', 'Un futuro invadido por microprocesadores, en el que la información es la materia prima. Vaqueros como Henry Dorrett Case se ganan la vida hurtando información, traspasando defensas electrónicas, bloques tangibles y luminosos, como rascacielos geométricos. En este espeluznante y sombrío futuro la mayor parte del este de Norteamérica es una única y gigantesca ciudad, casi toda Europa un vertedero atómico y Japón una jungla de neón, corruptora y brillante, donde una persona es la suma de sus vicios.', 'http://books.google.com/books/content?id=Vxu6GQAACAAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api', 320, 'Fiction', '2006', 'Vxu6GQAACAAJ', '2026-08-02 12:09:29', '');
